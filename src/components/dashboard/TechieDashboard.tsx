      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-card/50 rounded-lg text-center">
                ...
                <p className="text-sm text-muted-foreground">Highlight Your Work</p>
            </div>
             <div className="p-4 bg-card/50 rounded-lg text-center">
                <Share2 className="h-8 w-8 text-primary mx-auto mb-2" />
                <p className="font-bold text-lg">Share Resources</p>
                <p className="text-sm text-muted-foreground">Contribute to the Hub</p>
            </div>
             <div className="p-4 bg-card/50 rounded-lg text-center">
                <Puzzle className="h-8 w-8 text-primary mx-auto mb-2" />
                <p className="font-bold text-lg">Find Opportunities</p>
                <p className="text-sm text-muted-foreground">Collaborate & Innovate</p>
            </div>
        </div>
      </CardContent>
    </Card>
